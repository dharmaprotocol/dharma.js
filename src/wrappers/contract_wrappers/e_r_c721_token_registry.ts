...
export class ERC721TokenRegistryContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<ERC721TokenRegistryContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<ERC721TokenRegistryContract> {
