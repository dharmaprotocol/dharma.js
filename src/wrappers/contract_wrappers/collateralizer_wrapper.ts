...
export class CollateralizerContract extends BaseContract {
    ...
    public returnCollateral = {
        async sendTransactionAsync(agreementId: string,
        ...
        async estimateGasAsync(agreementId: string,
        ...
        getABIEncodedTransactionData(agreementId: string,
    ...
    public timestampAdjustedForGracePeriod = {
        async callAsync(gracePeriodInDays: BigNumber,
    ...
    public revokeCollateralizeAuthorization = {
        async sendTransactionAsync(agent: string,
                                   txData: TxData = {},): Promise<string> {
            const self = this as CollateralizerContract;
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
        ...
        async estimateGasAsync(agent: string,
                               txData: TxData = {},): Promise<number> {
            const self = this as CollateralizerContract;
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
        ...
        getABIEncodedTransactionData(agent: string,
                                     txData: TxData = {},): string {
            const self = this as CollateralizerContract;
    ...
    public unpackCollateralParametersFromBytes = {
        async callAsync(parameters: string,
                        defaultBlock?: Web3.BlockParam,): Promise<[BigNumber, BigNumber, BigNumber]> {
            const self = this as CollateralizerContract;
    ...
    public agreementToCollateralizer = {
        async callAsync(index_0: string,
                        defaultBlock?: Web3.BlockParam,): Promise<string> {
            const self = this as CollateralizerContract;
            const result = await promisify<string>(
    ...
    public transferOwnership = {
        async sendTransactionAsync(newOwner: string,
                                   txData: TxData = {},): Promise<string> {
            const self = this as CollateralizerContract;
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
        ...
        async estimateGasAsync(newOwner: string,
                               txData: TxData = {},): Promise<number> {
            const self = this as CollateralizerContract;
            const txDataWithDefaults = await self.applyDefaultsToTxDataAsync(
                txData,
        ...
        getABIEncodedTransactionData(newOwner: string,
                                     txData: TxData = {},): string {
            const self = this as CollateralizerContract;
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<Collateralizer> {
    ...
    static async at(address: string,
                    web3: Web3,
                    defaults: Partial<TxData>,): Promise<CollateralizerContract> {
        const web3Utils = new Web3Utils(web3);
