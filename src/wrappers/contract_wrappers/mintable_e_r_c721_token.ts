...
export class MintableERC721TokenContract extends BaseContract {
    ...
    static async deployed(web3: Web3, defaults: Partial<TxData>): Promise<MintableERC721TokenContract> {
    ...
    static async at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MintableERC721TokenContract> {
