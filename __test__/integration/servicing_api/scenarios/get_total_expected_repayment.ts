...
export const GET_TOTAL_EXPECTED_REPAYMENT: GetTotalExpectedRepaymentScenario[] = [
    ...
    {
        description: "over 31 days at 10% interest amortized monthly from 1 Ether principal",
        termLength: 31,
        principalAmount: Units.ether(1),
        interestRate: new BigNumber(0.1),
    ...
    {
        description: "over 61 days at 10% interest amortized monthly from 1 Ether principal",
        termLength: 61,
        principalAmount: Units.ether(1),
        interestRate: new BigNumber(0.1),
        amortizationUnit: "days",
    ...
    {
        description: "over 73 days at 5% interest amortized monthly from 2.5 Ether principal",
        termLength: 73,
