...
export class SeizeCollateralRunner {
    ...
    private async setBalances(scenario: SeizeCollateralScenario): Promise<void> {
    ...
    private async setApprovals(scenario: SeizeCollateralScenario): Promise<void> {
    ...
    private generateDebtOrder(scenario: SeizeCollateralScenario): DebtOrder.Instance {
    ...
    private async generateAndFillOrder(scenario: SeizeCollateralScenario): Promise<void> {
