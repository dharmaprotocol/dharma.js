...
var TermsContractRegistryContract = (function (_super) {
    __extends(TermsContractRegistryContract, _super);
    function TermsContractRegistryContract(web3ContractInstance, defaults) {
        var _this = _super.call(this, web3ContractInstance, defaults) || this;
        _this.setSimpleInterestTermsContractAddress = {
            sendTransactionAsync: function (tokenAddress, termsContract, txData) {
            ...
            estimateGasAsync: function (tokenAddress, termsContract, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
            ...
            getABIEncodedTransactionData: function (tokenAddress, termsContract, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.setSimpleInterestTermsContractAddress.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.symbolToTermsContractAddress = {
        ...
        _this.getSimpleInterestTermsContractAddress = {
            callAsync: function (tokenAddress, defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
    ...
    TermsContractRegistryContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new TermsContractRegistryContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("TermsContractRegistry", currentNetwork));
                        }
                        return [3 /*break*/, 5];
                    case 4: throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("TermsContractRegistry", currentNetwork));
                    case 5: return [2 /*return*/];
                }
            });
        });
    };
    TermsContractRegistryContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    TermsContractRegistryContract.getArtifactsData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, fs.readFile("src/artifacts/TermsContractRegistry.json", "utf8")];
                    case 1:
                        artifact = _b.sent();
                    ...
                    case 2:
                        e_1 = _b.sent();
                        throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.ARTIFACTS_NOT_READABLE("TermsContractRegistry"));
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    return TermsContractRegistryContract;
...
//# sourceMappingURL=terms_contract_registry_wrapper.js.map