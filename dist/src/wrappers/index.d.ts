...
export declare type ContractWrapper = DebtKernelContract | DebtTokenContract | TokenTransferProxyContract | ERC20Contract | TermsContractRegistryContract | RepaymentRouterContract | SimpleInterestTermsContractContract | TokenRegistryContract;
export { BaseContract, DebtOrderWrapper, DebtKernelContract, DebtTokenContract, DummyTokenContract, TokenRegistryContract, TokenTransferProxyContract, ERC20Contract, TermsContractRegistryContract, SimpleInterestTermsContractContract, RepaymentRouterContract };
