...
export declare class DummyTokenRegistryContract extends BaseContract {
    setTokenAddress: {
    ...
    static deployed(web3: Web3, defaults: Partial<TxData>): Promise<DummyTokenRegistryContract>;
    static at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<DummyTokenRegistryContract>;
