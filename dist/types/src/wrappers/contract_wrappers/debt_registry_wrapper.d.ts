...
export declare class DebtRegistryContract extends BaseContract {
    ...
    getDebtorsDebts: {
        callAsync(debtor: string, defaultBlock?: Web3.BlockParam): Promise<string[]>;
    };
    getTerms: {
    ...
    get: {
        callAsync(issuanceHash: string, defaultBlock?: Web3.BlockParam): Promise<DebtRegistryEntry>;
    };
